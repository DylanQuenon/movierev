...
class PasswordUpdate
{
    ...
    #[Assert\Length(min:8, max:255, minMessage:"votre mot de passe doit faire plus de 8 caractères", maxMessage: "Votre mot de passe ne doit pas faire plus de 255 caractères")]

 ...
 */
final class Version20241003095349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, follower_id INT NOT NULL, followed_id INT DEFAULT NULL, INDEX IDX_A3C664D3AC24F853 (follower_id), INDEX IDX_A3C664D3D956F010 (followed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
